...
const rawVipGoldenSeriesProducts: RawSeriesProduct[] = [
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784650821/1_GANG_2_WAY_SWITCH._VG8111-2_v4ocdv.png',
    modelNo: 'VG8111-2',
    productType: '1 Gang Switch',
    features: ['With Switch'],
  },
  {
    ...
    image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784650819/2_GANG_2_WAY_SWITCH._VG8112-2_jlfogs.png',
    modelNo: 'VG8112-2',
    productType: '2 Gang Switch',
    features: ['With Switch'],
  },
