...
const rawLedDownLightProducts: RawSeriesProduct[] = [
  { id: 1, title: 'KITTY PANELUX 2 IN 1 DOWNLIGHT 6W', subtitle: 'Surface/Concealed', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784046219/KITTY_PANELUX_2_IN_1_DOWNLIGHT_6W_jzmmmw.png', modelNo: 'KTCL-PLSR-6W', productType: 'Panelux', features: ['6W'] },
  ...
  { id: 3, title: 'KITTY PANELUX 2 IN 1 DOWNLIGHT 18W', subtitle: 'Surface/Concealed', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784046184/KITTY_PANELUX_2_IN_1_DOWNLIGHT_18W_skv9dx.png', modelNo: 'KTCL-PLSR-18W', productType: 'Panelux', features: ['18W'] },
  { id: 4, title: 'KITTY SUPERNOVA DOWNLIGHT 6W', subtitle: 'Concealed', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784046244/KITTY_SUPERNOVA_DOWNLIGHT_6W_c3hocp.png', modelNo: 'KTCL-PLCR-6W', productType: 'Supernova', features: ['6W'] },
  ...
  { id: 6, title: 'KITTY SUPERNOVA DOWNLIGHT 18W', subtitle: 'Concealed', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784046237/KITTY_SUPERNOVA_DOWNLIGHT_18W_n1pjbe.png', modelNo: 'KTCL-PLCR-18W', productType: 'Supernova', features: ['18W'] },
];
