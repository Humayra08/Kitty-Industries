...
const rawExtensionSocketProducts: RawSeriesProduct[] = [
  ...
  { id: 3, title: '5-WAY EXTENSION SOCKET 2 PIN WHITE', subtitle: '2 Pin, White', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784031083/EXTENSION_SOCKET_5WAY_2PIN_WHITE_r2gzsq.png', modelNo: 'M525', productType: 'White', features: ['5-Way'] },
  { id: 4, title: '5-WAY EXTENSION SOCKET 3 PIN BLACK', subtitle: '3 Pin, Black', image: 'https://res.cloudinary.com/dcdo4venk/image/upload/v1784031066/EXTENSION_SOCKET_5WAY_3PIN_BLACK._B535_txhl5p.png', modelNo: 'B535', productType: 'Black', features: ['5-Way'] },
];
