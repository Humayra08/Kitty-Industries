    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative bg-white py-6 sm:py-8 md:py-10 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-40 select-none">
          ...
          >
            <path
              d="M-100,100 C300,300 800,-50 1600,150"
              stroke="rgba(227,0,15,0.08)"
              strokeWidth="1.5"
            />
            <path
              d="M-100,180 C400,380 900,30 1600,230"
              stroke="rgba(227,0,15,0.08)"
              strokeWidth="1.5"
            />
            <path
              d="M-100,260 C500,460 1000,110 1600,310"
              stroke="rgba(227,0,15,0.08)"
              strokeWidth="1.5"
            />
          </svg>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <p className="text-sm sm:text-base text-gray-500 max-w-lg leading-relaxed">
                Explore our range of electrical accessories, from cable
                management to a wide variety of everyday essentials.
              </p>
            </div>
